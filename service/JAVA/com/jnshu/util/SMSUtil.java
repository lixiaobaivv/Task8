...
//    final String accessKeySecret = "6qgU9HPPKinZCQNYeXWoTCOqS7sjTg";//你的accessKeySecret，参考本文档步骤2
    //短信签名
//    final String SignName = "李琪";
    //短信模板
//    final String TemplateCode = "SMS_139405138";
    ...
    public Boolean SMSclient(String PhoneNumbers,String Rand_Code) throws ClientException {
        //设置超时时间-可自行调整
        logger.info("手机号码="+PhoneNumbers,Rand_Code);
        logger.info("keyId"+accessKeyId            +accessKeySecret     +SignName+TemplateCode);
