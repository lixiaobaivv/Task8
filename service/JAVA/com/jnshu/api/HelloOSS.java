...
public class HelloOSS {
    static Logger logger = LoggerFactory.getLogger(HelloOSS.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String fileKey = "headicon.png";
            ossClient.putObject(bucketName, fileKey, new File("C:\\Users\\Yzzzt\\Desktop\\lixiaobaiv.png"));
            ...
            for (OSSObjectSummary object : objectSummary) {
                ...
                System.out.println("\t" + object.getOwner());
            }
