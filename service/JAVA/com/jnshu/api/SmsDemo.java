...
//替换成你的AK
        final String accessKeyId = "LTAI0BfDbJOsdSCv";//你的accessKeyId,参考本文档步骤2
...
//初始化ascClient,暂时不支持多region（请勿修改）
        ...
        request.setPhoneNumbers("18656567017");
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("李琪");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_139445213");
