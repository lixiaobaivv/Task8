...
<div style="width:500px;margin:0px auto;text-align:center">
    ...
    <div style="text-align:center;margin-top:40px">
        ...
        <form method="post" action="${pageContext.request.contextPath }/Register">
            ...
            手机号：<input name="userIphone" value="" type="text"> <br><br>
            邮箱账号：<input name="emali" value="" type="text"> <br><br>
...
<div class="container">
    ...
    <div class="signup_forms" class="signup_forms">
        <div id="signup_forms_container" class="signup_forms_container">
            ...
            <form class="signup_form_form" id="sign_form" method="post" action="${pageContext.request.contextPath }/Register">
                <div class="signup_account" id="signup_account">
                    <div class="from_iphone">
                        <input type="text" name="userIphone" placeholder="userIphone" id="userIphone">
                    </div>
                    <div class="form_user">
        ...
        <input type="submit" id="signup_forms_submit" ><span style="font-size:16px;"><strong></strong></span></input>
    </div>
    </form>
    <form action="${pageContext.request.contextPath}/upload" method="post"  enctype="multipart/form-data">
        <table align="center" border="1" width="40%">
            ...
            <tr>
                <td>选择图片</td>
                <td><input id="head_tx" type="file" name="head_tx" /></td>
            </tr>
            <tr>
...
<div class="footer">
    <div class="footer_signup_link">
        <a class="signup_link" href="${pageContext.request.contextPath }/login">返回</a>
