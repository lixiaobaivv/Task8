...
<form name=form1 action="${pageContext.request.contextPath }/iphoneLogin" method="post" onsubmit="return isValidate(form1)">
    <table align="center">
        <tr>
            <td>手机号：</td>
        ...
        <tr>
            <td><input type="button"  value="注册" onclick="location.href='/register'"></td>
            <td><input type="reset" value="重置"></td>
            <td><input type="reset" value="使用账号登录" onclick="location.href='/login'"></td>
